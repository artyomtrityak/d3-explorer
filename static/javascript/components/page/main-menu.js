        ...
        <ul className="nav ml-3 mb-5">
          ...
          <li
            className={cn("nav-item", {
              active: matchPath(pathname, { path: "/bar" }) || pathname === "/"
            })}
          >
          ...
          <li
            className={cn("nav-item", {
              active: matchPath(pathname, { path: "/circle" })
            })}
          >
            <NavLink
          ...
          <li
            className={cn("nav-item", {
              active: matchPath(pathname, { path: "/pie" })
            })}
          >
          ...
          <li
            className={cn("nav-item", {
              active: matchPath(pathname, { path: "/line" })
            })}
          >
          ...
          <li
            className={cn("nav-item", {
              active: matchPath(pathname, { path: "/tree" })
            })}
          >
          ...
          <li
            className={cn("nav-item", {
              active: matchPath(pathname, { path: "/3d" })
            })}
          >
